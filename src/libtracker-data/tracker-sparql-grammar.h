...
static const TrackerGrammarRule helper_BuiltInCall_or_1[] = { S(helper_BuiltInCall_seq_1), T(NIL), NIL };
...
static const TrackerGrammarRule helper_MultiplicativeExpression_or[] = { S(helper_MultiplicativeExpression_seq_1), S(helper_MultiplicativeExpression_seq_1), NIL };
...
static const TrackerGrammarRule helper_RelationalExpression_or[] = { S(helper_RelationalExpression_seq_1), S(helper_RelationalExpression_seq_2), S(helper_RelationalExpression_seq_3), S(helper_RelationalExpression_seq_4), S(helper_RelationalExpression_seq_5), S(helper_RelationalExpression_seq_6), S(helper_RelationalExpression_seq_7), S(helper_RelationalExpression_seq_8), NIL };
...
static const TrackerGrammarRule helper_ArgList_seq_2[] = {  L(OPEN_PARENS), OPT(helper_ArgList_opt), R(Expression), GTE0(helper_ArgList_seq_1), L(CLOSE_PARENS), NIL };
 ...
 */
static const TrackerGrammarRule helper_TriplesTemplate_seq[] = { L(DOT), R(TriplesTemplate), NIL };
static const TrackerGrammarRule helper_TriplesTemplate_opt[] = { S(helper_TriplesTemplate_seq), NIL };
static const TrackerGrammarRule rule_TriplesTemplate[] =  { R(TriplesSameSubject), OPT(helper_TriplesTemplate_opt), NIL };
 ...
 */
static const TrackerGrammarRule helper_Quads_gt0[] = { R(TriplesTemplate), NIL };
...
static const TrackerGrammarRule rule_Quads[] = { GT0(helper_Quads_gt0), GTE0(helper_Quads_gte0), NIL };
...
static const TrackerGrammarRule helper_Modify_opt[] = { S(helper_Modify_seq_1), NIL };
static const TrackerGrammarRule helper_Modify_seq_2[] = { R(DeleteClause), R(InsertClause), NIL };
...
static const TrackerGrammarRule rule_Modify[] = { OPT(helper_Modify_opt), OR(helper_Modify_or), GTE0(helper_Modify_gte0), L(WHERE), R(GroupGraphPattern), NIL };
...
static const TrackerGrammarRule helper_SelectClause_or_3[] = { GT0(helper_SelectClause_gt0), L(GLOB), NIL };
 ...
 */
static const TrackerGrammarRule helper_Update_seq_1[] = { L(SEMICOLON), R(Update1), NIL };
